...
- ATS structure: prioritize parseable one-column content. Keep skills extractable in additional.technicalSkills.
- Put the strongest 8-12 ATS keywords in additional.technicalSkills, ordered by relevance.
- If the resume contains tools/platforms/languages, place the 4-6 most critical technical tools first.
- Experience bullets should follow ACTION + keyword/context + result when the source supports it.
- Never invent metrics or tools. If no result is present, keep the bullet factual without fake numbers.
...
- ATS structure target: first visible content after identity must emphasize 8-12 key skills, then 4-6 critical technical skills.
- Reorder additional.technicalSkills by job relevance. Keep all original skills, but place the best matches first.
- Use short, parseable experience bullets: ACTION + job keyword/context + concrete result when supported.
- Keep work/education dates in short parseable format when possible: YYYY-MM - YYYY-MM or YYYY-MM - Present. Do not invent days.
