...
> Projet personnel base sur le projet open source [Resume Matcher](https://github.com/srbhr/Resume-Matcher) de `srbhr`, conserve sous licence Apache 2.0. Cette version sert de base a des adaptations autour de l'analyse ATS, de l'amelioration de CV et de l'utilisation de modeles IA via OpenRouter.
